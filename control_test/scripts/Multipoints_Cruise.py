...
def Multipoints_Cruise():
    global markerArray, count, index, add_more_point, try_again, mark_pub, goal_pub, goal_status_pub, markerArry, count, index, add_more_point, try_again, mark_pub, goal_pub, goal_status_pub
    markerArray = MarkerArray()
    count = 0
    index = 0
    add_more_point = 0
    try_again = 1
    rospy.init_node('multipoints_cruise_node')
    ...
    goal_status_pub = rospy.Subscriber('/move_base/result', MoveBaseActionResult, status_callback)
