...
#ifndef __MROBOTIT_H_
#define __MROBOTIT_H_
...
#define GRYOSCOPE_ZERO_MAX 0.0005f
#define GRYOSCOPE_ZERO_MIN -0.0005f
...
{
	public:
		Mrobotit_start_object();
		~Mrobotit_start_object();

		/* /cmd_vel topic call function */
		void cmd_velCallback(const geometry_msgs::Twist &twist_aux);
		void cmd_AmclvelCallback(const geometry_msgs::PoseWithCovarianceStampedConstPtr &Pose);
		void cmd_velScanCallback(const sensor_msgs::LaserScan::ConstPtr& scan);
	...
	private:
		...
		ros::Subscriber cmd_vel_sub, amcl_sub,scan_sub;
